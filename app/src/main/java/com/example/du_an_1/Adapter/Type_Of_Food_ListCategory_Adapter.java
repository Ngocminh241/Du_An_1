...
//        mainActivity = (MainActivity) context;
    ...
    @NonNull
    @Override
    public Type_Of_Food_ListCategory_Adapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View inflate = LayoutInflater.from(parent.getContext()).inflate(R.layout.viewholder_category,parent,false);


        return new Type_Of_Food_ListCategory_Adapter.ViewHolder(inflate);
    }
