...
public class Burger_List extends AppCompatActivity {
    ...
    private void bottomNavigation(){
        ...
        floatingActionButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(Burger_List.this, Cart_Activity.class));
            }
        });
        homeBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Burger_List.this, MainActivity.class));
            }
        });
    }
